...
class MaterialConverter(QtWidgets.QDialog):
    ...
    def show_help(self):
        ...
        help_window.setWindowTitle("使用帮助 - 材质转换工具")
        help_window.setMinimumSize(800, 600)
        help_window.resize(900, 700)
        help_window.setWindowFlags(help_window.windowFlags() | QtCore.Qt.WindowMinimizeButtonHint | QtCore.Qt.WindowMaximizeButtonHint | QtCore.Qt.WindowCloseButtonHint)
...
<p>本工具用于在Maya中进行材质类型之间的转换，支持批量转换和自定义映射关系。</p>

<h2>使用步骤</h2>

<h3>1. 配置材质类型映射</h3>
<ul>
<li>在"材质类型映射配置"表格中，添加源材质类型和目标材质类型的映射关系</li>
<li>可以双击单元格手动输入材质类型，或点击"加载源"/"加载目标"按钮从选择的材质节点载入</li>
<li>当只有一行且源为空时，会将所有材质转换为该目标类型</li>
<li>可以点击"保存预设"将当前配置保存为.mlist文件，下次通过"加载预设"快速恢复</li>
</ul>

<h3>2. 选择映射文件</h3>
<ul>
<li>点击"浏览..."按钮选择包含映射.mmap文件的文件夹，会自动加载其中所有映射文件</li>
<li>映射文件会自动根据源材质类型和目标材质类型在映射文件夹中查找</li>
<li>映射文件目录: {}</li>
<li>点击"打开文件夹"可快速打开映射文件目录进行管理</li>
</ul>

<h3>3. 执行转换</h3>
<ul>
<li>点击"转换选择"按钮，转换选择中的材质</li>
<li>点击"转换全部"按钮，转换所有符合映射配置的材质</li>
</ul>

<h3>4. 转换选项</h3>
<ul>
<li>复制纹理连接: 保留材质的纹理连接</li>
<li>保留原始材质: 转换后保留原始材质</li>
<li>自动应用到选择对象: 自动将新材质应用到选择的对象</li>
</ul>
...
<h3>材质类型映射预设</h3>
<ul>
<li>点击"保存预设"可将当前表格中的材质类型映射配置保存为.mlist文件</li>
<li>点击"加载预设"可从.mlist文件恢复之前保存的配置</li>
<li>预设文件保存在映射文件夹的 mapping_type_presets 子目录中</li>
</ul>
...
<h3>1. 未找到映射文件</h3>
<ul>
<li>确保映射文件夹中存在对应的映射文件</li>
<li>映射文件命名格式: {{source_type}}_{{target_type}}.mmap</li>
<li>例如: lambert_openPBRSurface.mmap</li>
<li>点击"打开文件夹"检查映射文件是否存在</li>
</ul>

<h3>2. 材质转换失败</h3>
<ul>
<li>检查源材质和目标材质是否存在</li>
<li>确保映射文件格式正确</li>
<li>检查材质属性是否存在</li>
</ul>
...
<ul>
<li>材质可能被其他节点引用</li>
<li>可以手动删除或取消"保留原始材质"选项</li>
</ul>

<h3>4. 材质应用失败</h3>
<ul>
<li>检查对象是否存在</li>
<li>确保对象有可着色的shape节点</li>
</ul>
...
<p>属性映射文件为.mmap格式（JSON结构），包含以下内容:</p>
<pre>
{{
    "name": "材质映射名称",
    "source_type": "源材质类型",
...
<ul>
<li>source_attribute: 源材质的属性名称</li>
<li>target_attribute: 目标材质的属性名称</li>
<li>default_value: 当源属性不存在时使用的默认值</li>
<li>transform: 可选的转换函数名称（预留）</li>
</ul>

<h2>快捷键与按钮说明</h2>

<ul>
<li>双击表格单元格: 编辑材质类型</li>
<li>选择行后点击"删除选中": 删除选中行</li>
<li>点击"添加行": 添加新的映射行</li>
<li>点击"清空全部": 清空所有映射行</li>
<li>点击"加载源": 从选择的材质节点加载源材质类型</li>
<li>点击"加载目标": 从选择的材质节点加载目标材质类型</li>
<li>点击"保存预设": 保存当前材质类型映射配置</li>
<li>点击"加载预设": 加载之前保存的材质类型映射配置</li>
<li>点击"打开文件夹": 打开映射文件所在目录</li>
</ul>

<hr>
<p><small>版本: 1.1.0 &nbsp;&nbsp; 更新日期: 2026-05-08</small></p>
        """.format(self.mapping_base_dir)
        ...
        text_browser.setStyleSheet("""
            ...
            QTextBrowser ul, QTextBrowser li {
                font-size: 18px;
                line-height: 1.6;
                margin: 5px 0;
            }
        ...
        close_btn = QtWidgets.QPushButton("关闭")
        close_btn.setStyleSheet("background-color: #2196F3; color: white; font-weight: bold; padding: 8px 15px;")
